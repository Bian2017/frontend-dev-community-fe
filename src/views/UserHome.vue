<template>
  <div>
    <div class="fly-home fly-panel" style="background-image: url();">
      <img :src="userInfo.pic ? userInfo.pic: '/img/avatar.jpg'" alt="头像" />
    ...
    <span>（该号已被封）</span>
      ...
      <p class="fly-home-info">
        ...
        <span>{{userInfo.created | formatDate }} 加入</span>
...
<script>
import { getInfo, getPostPublic, getCommentList } from "@/services/user";
